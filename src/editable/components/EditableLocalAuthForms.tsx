...
const inputClass = 'h-[54px] rounded-[18px] border border-black/10 bg-[#f7fafb] px-5 text-base font-bold text-[#202334] outline-none transition placeholder:text-[#202334]/35 focus:border-[var(--slot4-accent)] focus:bg-white'
const buttonClass = 'inline-flex h-14 items-center justify-center rounded-full bg-[var(--slot4-accent)] px-6 text-sm font-black uppercase tracking-[0.18em] text-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-[0_16px_30px_rgba(0,105,95,0.22)] disabled:opacity-60'
